...
public class CategoryMySQLGatewayTest {
    ...
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        ...
        final var filmes = Category.newCategory("Filmes", "Category description movies", true);
        final var series = Category.newCategory("Séries", "Category description series", true);
        final var documentarios = Category.newCategory("Documentários", "Category description docs", true);
        ...
        final var query = new CategorySearchQuery(0, 1, "MOVIES", "name", "asc");
        final var actualResult = categoryGateway.findAll(query);
